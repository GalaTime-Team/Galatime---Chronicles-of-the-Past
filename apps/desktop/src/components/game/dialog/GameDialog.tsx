...
const GameDialog: React.FC<GameDialogProps> = ({
    ...
    // Repaginate when the dialog width changes.
    useEffect(() => {
    ...
    // Space and ArrowRight should advance the dialog just like a left click.
    useEffect(() => {
                ...
                <AnimatePresence>
                    {isIndicatorVisible && (
                        <motion.div
                            ...
                            className="absolute bottom-2 right-4 text-white text-lg font-bold leading-none"
                        >
                            &gt;&gt;
                        </motion.div>
                    )}
