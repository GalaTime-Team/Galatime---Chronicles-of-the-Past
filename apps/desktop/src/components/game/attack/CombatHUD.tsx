...
export const CombatHUD: React.FC<CombatHUDProps> = ({
  ...
  return (
    <div className={`flex flex-col gap-2 ${className}`}>
      {/* 5 - HP Bar: ltr, above attacks, width same as row */}
      ...
      {/* Main Content Area: [Attacks & Extra] + [MN & SN] */}
      <div className="flex flex-row gap-2 items-stretch">
        ...
        <div className="flex flex-col gap-2 flex-1">
          ...
          {/* 8 - Extra Movements: Organized in that exact way */}
          <div className="flex flex-row gap-2">
            ...
            {/* 9 - Weapon only shows if a weapon is given */}
            {weapon && (
              <ExtraMovementCard
        ...
        {/* 6 - MN & SN: btt, to the right of the attacks + extra, height same as the column */}
        <div className="flex flex-row gap-2">
          <CombatStatsBar
            title="MN"
            showTitle
